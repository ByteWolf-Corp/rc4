...
def main():
    key = input("Enter the key you want to use for encryption/decryption: ")
    text = input("Enter the text you want to encrypt/decrypt: ")
    opt = input("Choose the action you want to do (Encrypt - e/Decrypt d): ")
    ...
    print("The ciphered/desciphered text is:", ciphertext)
